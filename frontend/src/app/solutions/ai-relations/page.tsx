          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20">
            ...
            <div className="relative">
              <div className="bg-gray-50 rounded-xl p-8 border border-gray-200">
                ...
                <div className="mb-6 text-sm text-gray-500">REGIONAL CREDIT UNION</div>
                <p className="text-gray-600 mb-6">
                  "AI Relations transformed our member engagement strategy. We've seen a 38% increase in loan application rates from our existing members, and a 41% reduction in time spent on routine communications tasks."
                </p>
                <div className="font-medium">Sarah Johnson</div>
                <div className="text-sm text-gray-500">VP of Member Experience</div>
