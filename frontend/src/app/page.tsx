  ...
  return (
    <Layout>
            ...
            <div className="bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden">
              ...
              <div className="p-4 h-[400px] overflow-y-auto bg-gray-50">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start max-w-[80%]">
                    <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold mr-2 flex-shrink-0">
                      AI
                    </div>
              ...
              <div className="p-4 border-t border-gray-200 bg-white">
                <div className="flex items-center">
                  ...
                  />
                  <button className="bg-blue-600 text-white py-2 px-4 rounded-r-md hover:bg-blue-700 transition-colors">
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Enterprise Configuration</h2>
