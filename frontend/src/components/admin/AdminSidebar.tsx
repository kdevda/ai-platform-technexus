    ...
    >
      ...
      <nav className="mt-6">
        <ul className="space-y-2 px-2">
          ...
          <li>
            <Link 
              href="/platform/admin/layout-management"
              className={`flex items-center p-3 rounded-md transition-colors group ${
                isActive('/platform/admin/layout-management') 
                  ? 'bg-blue-700 text-white' 
                  : 'hover:bg-gray-800 text-gray-300 hover:text-white'
              }`}
            >
              <svg className={`w-5 h-5 ${isActive('/platform/admin/layout-management') ? 'text-white' : 'group-hover:text-blue-400'}`}
                fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" />
              </svg>
              <span className={`ml-3 ${expanded ? 'block' : 'hidden'}`}>Layout Management</span>
            </Link>
          </li>
